...
tiles {
    ...
    multiAttributeTile(name:"DeviceTrigger", type:"generic", width:6, height:4) {
			tileAttribute("device.triggerswitch", key: "PRIMARY_CONTROL") {
				attributeState "triggeroff", label:'IDLE' , action: "on", icon: "st.Lighting.light99-hue", backgroundColor:"#ffffff", nextState: "trying"
				attributeState "triggeron", label: 'ALARM', action: "off", icon: "st.alarm.alarm.alarm", backgroundColor: "#79b821", nextState: "trying"
				attributeState "trying", label: 'TRYING', action: "", icon: "st.Lighting.light99-hue", backgroundColor: "#FFAA33"
		}
	}  
}
